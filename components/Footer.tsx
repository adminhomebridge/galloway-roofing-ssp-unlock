      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid md:grid-cols-2 gap-10 md:gap-8">
          ...
          <div className="max-w-md">
            <span className="inline-block bg-white rounded-2xl px-6 py-4 mb-5 shadow-card">
              <img src="/images/galloway-logo.png" alt={BRAND.partnerName} className="h-20 w-auto" />
            </span>
